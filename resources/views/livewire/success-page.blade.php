          ...
          <div class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start">
            <div class="flex flex-col items-start justify-start space-y-2">
              <p class="text-lg font-semibold leading-4 text-left text-gray-800 dark:text-gray-400">
                Hi, {{ $order->address->first_name }}</p>
              <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $order->address->jalan }}</p>
              <p class="text-sm leading-4 text-gray-600 dark:text-gray-400">{{ $order->address->kecamatan }} {{ $order->address->kabkota }} {{ $order->address->provinsi }}</p>
      ...
      <div class="px-4 mb-10">
        <div class="flex flex-col items-stretch justify-center w-full space-y-4 md:flex-row md:space-y-0 md:space-x-8">
          ...
          <div class="flex flex-col w-full px-2 space-y-4 md:px-8 ">
            <h2 class="mb-2 text-xl font-semibold text-gray-700 dark:text-gray-400">Take Order:</h2>
              ...
              <div class="flex items-center justify-center space-x-2">
                ...
                <div class="flex flex-col items-center justify-start">
                  <p class="text-lg font-semibold leading-6 text-gray-800 dark:text-gray-400">
                    Delivery<br><span class="text-sm font-normal">No Shipping Ambil Di Warung</span>
                  </p>
                </div>
              </div>
